...
6. After logging in, run the following command: ```bash <(curl -sL https://raw.githubusercontent.com/CC-IS/parcel/master/install/web-install.sh) -r 20-033-MakerTracker
 -a CC-IS```
